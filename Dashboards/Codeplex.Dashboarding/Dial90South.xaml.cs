//-----------------------------------------------------------------------
// <copyright file="Dial90South.xaml.cs" company="David Black">
...
namespace Codeplex.Dashboarding
{
    ...
    public partial class Dial90South : Dial90
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Dial90South"/> class.
        /// </summary>
        public Dial90South()
        {
            InitializeComponent();
        ...
        {
            return -225 + (CurrentNormalizedValue * 90);
        }
    }
}
