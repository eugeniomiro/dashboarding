...
namespace Codeplex.Dashboarding
{
    ...
    /// now.
    /// </summary>
    public static class MatrixLedCharacterDefintions
    {
        /// <summary>
        /// Empty square, shows an unknown character
        /// </summary>
        public static readonly byte[] UnknownCharacter = { 0x3e, 0x22, 0x22, 0x22, 0x3e,0 };

        /// <summary>
        /// Datastructure containing the mapping from character to leds
        /// </summary>
        public static Dictionary<string, byte[]> CharacterDefintions = new Dictionary<string, byte[]>
        {
            // space
...
{ "}", new byte [] { 0,65,54,8,0,0} },
        ...
        /// <returns></returns>
        public static byte[] GetDefintion(string character)
        {
            if (CharacterDefintions.ContainsKey(character))
                return CharacterDefintions[character];
