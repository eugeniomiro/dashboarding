//-----------------------------------------------------------------------
// <copyright file="Dial90North.xaml.cs" company="David Black">
...
namespace Codeplex.Dashboarding
{
    ...
    public partial class Dial90North : Dial90
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Dial90North"/> class.
        /// </summary>
        public Dial90North()
        {
            InitializeComponent();
        ...
        {
            return -45 + (CurrentNormalizedValue * 90);
        }
    }
}
